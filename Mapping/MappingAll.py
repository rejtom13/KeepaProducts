...
class MappingAll:
    ...
    def get_amazon_bestsellers_products(self, cursor):
        cursor.execute("Select asin, ean from amazon_products")
        self.amazon_bestsellers_product_list = [[str(asin), str(ean)] for asin, ean in cursor.fetchall()]

    def get_storage_products(self, cursor):
    ...
    def get_mapped_products(self, cursor):
        cursor.execute("Select supplier, ean, asin from mapping_all_products")
    ...
    def prepare_add_query(self, supplier, ean, asin, cursor):
        ...
        self.query = (
            "INSERT INTO mapping_all_products (supplier,ean,asin)"
